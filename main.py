...
""" 
import torch
#os.environ['CUDA_VISIBLE_DEVICES'] = ','.join([str(i) for i in range(torch.cuda.device_count())])from models_CIFAR10.resnet_layer_input import *
...
if __name__=='__main__':
    ...
    QuantizedNet(args.dataset,args.model_name,args.batch_size,args.lr,args.kbits,args.require_first_test,args.quantized_first_and_last)
